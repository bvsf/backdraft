# Generated by Django 2.1.2 on 2019-03-23 02:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alergeno', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='salud.Alergenos', verbose_name='Alérgeno')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('institucion', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='personas.Institucion', verbose_name='Institución')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observaciones', models.TextField(blank=True, max_length=1000, null=True, verbose_name='Observaciones')),
                ('bombero', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='bomberos.Bombero', verbose_name='Bombero')),
                ('clinica', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='salud.Clinica', verbose_name='Clínica')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('plan', models.TextField(max_length=255, verbose_name='Plan')),
                ('descripcion', models.TextField(max_length=1000, verbose_name='Descripción')),
                ('obraSocial', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='obraSocial', to='salud.ObraSocial', verbose_name='Obra Social')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='medicoCabecera',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='salud.MedicoCabecera', verbose_name='Médico de Cabecera'),
        ),
        migrations.AddField(
            model_name='coberturamedica',
            name='planMedico',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='salud.PlanMedico', verbose_name='Plan Médico'),
        ),
        migrations.AlterUniqueTogether(
            name='coberturamedica',
