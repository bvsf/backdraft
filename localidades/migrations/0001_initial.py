# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-27 22:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=255, verbose_name='Nombre')),
                ('abreviatura', models.CharField(blank=True, max_length=255, null=True, verbose_name='Abreviatura')),
                ('pais', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pais', to='localidades.Pais', verbose_name='País')),
            ],
            options={
