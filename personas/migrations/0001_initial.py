...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='telefono',
            name='entidad',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='entidad_telefono', to='personas.Entidad'),
        ),
        migrations.AddField(
            model_name='direccionweb',
            name='entidad',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='entidad_direccionweb', to='personas.Entidad'),
        ),
        migrations.AddField(
            model_name='direccionpostal',
            name='entidad',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='entidad_direccionpostal', to='personas.Entidad'),
        ),
        migrations.AddField(
            model_name='direccionpostal',
            name='localidad',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='localidad', to='localidades.Localidad', verbose_name='Localidad'),
        ),
        migrations.AddField(
            model_name='direccionelectronica',
            name='entidad',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='entidad_direccionelectronica', to='personas.Entidad'),
        ),
        migrations.AddField(
            model_name='cuartelero',
            name='persona',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='cuarteleros', to='personas.Persona', verbose_name='Persona'),
        ),
    ]
